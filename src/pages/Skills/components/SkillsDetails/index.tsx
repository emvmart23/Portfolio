...
export const levelSkills = [
  ...
  },
  {
    ...
    level: <Slider className="w-[48%]" disabled defaultValue={[80]} step={1} />,
  },
];
  ...
  return (
    <>
      <div className="w-full md:min-w-[453px]">
        <AnimatedTitle
          text="Acerca de mi habilidades..."
          className="font-bold text-[1.4rem] mb-7"
        />
        <ul className="w-full">
